...
<head>
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.3.1/js/bootstrap.min.js"></script>
    ...
    <!-- Favicon -->
    <link rel="icon" href="img/core-img/nav logo.png">
                                ...
                                <ul>
                                    ...
                                    <li><a href="#">Catagory</a>
                                        ...
                                        <li><a href="horror.php">Horror Books</a></li>
                                            ...
                                            <li><a href="hindi.php">Hindi Books</a></li>
                                    ...
                                    <!-- <li><a href="#">Trending</a>
                                        <div class="megamenu">
                                            ...
                                            <ul class="single-mega cn-col-4">
                                                ...
                                                <li><a href="archive.php">Abol-Tabol</a></li>
                                                <li><a href="video-post.php">SpiderMan</a></li>
                                                <li><a href="single-post.php">Captain Marvel</a></li>
                                                <li><a href="about.php">Ha Ja Ba Ra La</a></li>
                                                <li><a href="contact.php">Iron Man</a></li>
                                                <li><a href="login.php">Jhalapala-By-Sukumar-Roy</a></li>
                                            </ul>
                                            <ul class="single-mega cn-col-4">
                                                <li><a href="thriller.php"><b>Thriller</a></li></b>
                                                <li><a href="archive.php">Byomkesh Bakshi Series</a></li>
                                                <li><a href="video-post.php">Obsessed</a></li>
                                                <li><a href="single-post.php">Kiriti Roy Detective</a></li>
                                                <li><a href="about.php">Bloody Mary</a></li>
                                                <li><a href="contact.php">(un)lucky Number thirteen</a></li>
                                                <li><a href="login.php">Ami Rasahaya Vedi</a></li>
                                            </ul>
                                        </div>
                                    </li> -->
...
?>
    ...
    <section class="breadcrumb-area bg-img bg-overlay" style="background-image: url(img/thrillercov.jpg);">
    ...
    <div class="container"><br>
        ...
        <div class="row align-items-start">
          <div class="col">
            <img style="height: 390px;" src="img/thriller1.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
          ...
          <div class="col">
            <img style="height: 390px;" src="img/thriller2.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/thriller3.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;width: 300px; " src="img/thriller4.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
        ...
        <div class="row align-items-center">
          <div class="col">
            <img style="height: 390px;" src="img/thriller5.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/thriller6.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/thriller7.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/thriller8.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
        ...
        <div class="row align-items-end">
          <div class="col">
            <img style="height: 390px;" src="img/thriller9.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/thriller10.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/thriller11.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/thriller12.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
