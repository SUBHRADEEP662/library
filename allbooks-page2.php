                ...
                <nav class="classy-navbar justify-content-between" id="magNav">
                    ...
                    <div class="nav-content d-flex align-items-center">
                        ...
                        <div class="top-meta-data d-flex align-items-center">
                            ...
                            <!-- Admin -->
                            <div>
                            <a href="login.php" class="login-btn" id="admin"><i class="fa fa-user" aria-hidden="true"></i></a>
        ...
        <div class="row align-items-start">
          <div class="col">
            <?php
                                            ...
                                            <?php }
                                            ?><img style="height: 390px;" src="img/bg-img/4.jpg" alt=""></a>
            <?php
                                            if (isset($_SESSION['email'])) { ?>
                                                <a href="free_books.php">
                                            <?php }
          ...
          <div class="col">
            <?php
                                            ...
                                            <?php }
                                                ...
                                                <a href="subscribe.php" >
                                            <?php }
                                            ?><img style="height: 390px;" src="img/bg-img/26.jpg" alt=""></a>
            <?php
                                            if (isset($_SESSION['email'])) { ?>
                                                <a href="free_books.php">
                                            <?php }
          ...
          <div class="col">
            <?php
                                            ...
                                            <?php }
                                                ...
                                                <a href="subscribe.php" >
                                            <?php }
                                            ?><img style="height: 390px;" src="img/bg-img/150.jpg" alt=""></a>
            <?php
                                            if (isset($_SESSION['email'])) { ?>
                                                <a href="free_books.php">
                                            <?php }
          ...
          <div class="col">
            <?php
                                            ...
                                            <?php }
                                                ...
                                                <a href="subscribe.php" >
                                            <?php }
                                            ?><img style="height: 390px;" src="img/bg-img/162.jpg" alt=""></a>
            <?php
                                            if (isset($_SESSION['email'])) { ?>
                                                <a href="free_books.php">
                                            <?php }
          ...
          <div class="col">
            <?php
                                            ...
                                            <?php }
                                                ...
                                                <a href="subscribe.php" >
                                            <?php }
                                            ?><img style="height: 390px;" src="img/bg-img/165.png" alt=""></a>
            <?php
                                            if (isset($_SESSION['email'])) { ?>
                                                <a href="free_books.php">
                                            <?php }
          ...
          <div class="col">
            <?php
                                            ...
                                            <?php }
                                                ...
                                                <a href="subscribe.php" >
                                            <?php }
                                            ?><img style="height: 390px;" src="img/bg-img/170.jpg" alt=""></a>
            <?php
                                            if (isset($_SESSION['email'])) { ?>
                                                <a href="free_books.php">
                                            <?php }
          ...
          <div class="col">
            <?php
                                            ...
                                            <?php }
                                                ...
                                                <a href="subscribe.php" >
                                            <?php }
                                            ?><img style="height: 390px;" src="img/bg-img/171.jpg" alt=""></a>
            <?php
                                            if (isset($_SESSION['email'])) { ?>
                                                <a href="free_books.php">
                                            <?php }
          ...
          <div class="col">
            <?php
                                            ...
                                            <?php }
                                                ...
                                                <a href="subscribe.php" >
                                            <?php }
                                            ?><img style="height: 390px;" src="img/bg-img/161.jpg" alt=""></a>
            <?php
                                            if (isset($_SESSION['email'])) { ?>
                                                <a href="free_books.php">
                                            <?php }
