...
?>
    ...
    <section class="breadcrumb-area bg-img bg-overlay" style="background-image: url(img/horror00.jpg);">
    ...
    <div class="container"><br>
        <div class="row align-items-start">
          <div class="col">
            <img style="height: 390px;" src="img/horror1.png" alt="">
            
            <!-- <a href="bookpdf/hima-vemula-the-boy-in-the-striped-pajamas.pdf" class="btn btn-link">Read Now</a> -->
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
          ...
          <div class="col">
            <img style="height: 390px;" src="img/horror2.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/horror3.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/horror4.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
        ...
        <div class="row align-items-center">
          <div class="col">
            <img style="height: 390px;" src="img/horror5.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/horror6.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/horror7.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/horror000.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
        ...
        <div class="row align-items-end">
          <div class="col">
            <img style="height: 390px;" src="img/horror9.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/horror10.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/horror11.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/horror12.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
