        ...
        <div class="mag-main-menu" id="sticker">
            <div class="classy-nav-container breakpoint-off" style="background-color: rgb(241, 195, 134);">
                ...
                <nav class="classy-navbar justify-content-between" id="magNav">
                    ...
                    <!-- Nav brand -->
                    <a href="index.php" class="nav-brand"><img src="img/core-img/logo2.png" alt="" width="60px" height="70px"></a>
                    ...
                    <div class="contact-content-area bg-white mb-30 p-30 box-shadow">
                        ...
                        <div class="contact-information mb-30">
                            ...
                            <div class="single-contact-info d-flex align-items-center">
                                ...
                                <div class="text">
                                    <p>Our Office:</p>
                                    <h6>Gargi Memorial Institute of Technology, Baruipur, Kolkata</h6>
                                </div>
                            </div>
                        ...
                        <div class="contact-form-area">
                            <form action="user_con.php" method="post">
                                <div class="row">
                                    <div class="col-lg-6">
