                                    ...
                                    <!-- <li><a href="#">Trending</a>
                                        <div class="megamenu">
                                            <ul class="single-mega cn-col-4">
                                                ...
                                                <li><a href="171.pdf">I am Behind</a></li>
                                                <li><a href="171.pdf">Sleep Over</a></li>
                                                <li><a href="171.pdf">The Mine</a></li>
                                                <li><a href="171.pdf">The Face at the Window</a></li>
                                                <li><a href="171.pdf">Maya Villa </a></li>
                                                <li><a href="login.">Taranath Trantrick</a></li>
                                            </ul>
                                            <ul class="single-mega cn-col-4">
                                                <li><a href="drama.php"><b>Dramma Books:-</a></li></b>
                                                <li><a href="hist.php">The Way to Steel (SAMPLE)</a></li>
                                            ...
                                            <ul class="single-mega cn-col-4">
                                                ...
                                                <li><a href="hist.php">Archive</a></li>
...
?>
    ...
    <div class="container"><br>
        <div class="row align-items-start">
          <div class="col">
            <img style="height: 390px;" src="img/hist.jpg" alt="">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/hist2.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/hist3.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/hist4.png" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
        ...
        <div class="row align-items-center">
          <div class="col">
            <img style="height: 390px;" src="img/hist5.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/hist6.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/hist7.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/hist8.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
        ...
        <div class="row align-items-end">
          <div class="col">
            <img style="height: 390px;" src="img/hist9.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/hist10.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/hist11.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/hist12.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
        ...
        <nav>
            <ul class="pagination">
                ...
                <li class="page-item"><a class="page-link" href="hist2.php">2</a></li>
