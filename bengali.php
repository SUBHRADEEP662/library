...
?>
    ...
    <section class="breadcrumb-area bg-img bg-overlay" style="background-image: url(img/bengaliCov.jpg);">
    ...
    <div class="container"><br>
        ...
        <div class="row align-items-start">
          <div class="col">
            <img style="height: 390px;" src="img/comic1.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
          ...
          <div class="col">
            <img style="height: 390px;" src="img/comic4.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
        ...
        <div class="row align-items-center">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/bangla.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/comic8.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
        ...
        <div class="row align-items-end">
          <div class="col">
            <img style="height: 390px;" src="img/comic9.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/bengali2.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/bengali3.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
          ...
          <div class="col">
            <img style="height: 390px;" src="img/bengali4.jpg" alt="">
            <?php
                        if (isset($_SESSION['email'])) { ?>
                            <form>
                                <input type="button" value="Coming Soon" class="btn btn-info mx-auto d-block" title="Currently Unavailable">
